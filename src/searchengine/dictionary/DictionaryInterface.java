 ...
 * 
 *                           Copyright: Copyright (c) 2004 Carnegie Mellon
 *                           University
 * 
 *                           This program is part of an implementation for the
 *                           PARKR project which is about developing a search
 *                           engine using efficient Datastructures.
 * 
...
public interface DictionaryInterface<K extends Comparable<K>, V> {
	...
	/**
	 * This method takes a key value as input and retrives the corresponding
	 * value of it
	 * 
	 * @param str
	 * @return Value
