...
public class DictionaryDriver {
	...
	public static void main(String args[]) throws Exception {
		if (args.length < 1)
			System.out
					.println("Usage java DictionaryDriver <type of Dictionary>");
		else if (args[0].equals("list") || args[0].equals("hash")
				|| args[0].equals("myhash") || args[0].equals("bst")
				|| args[0].equals("avl")) {
