...
public class HttpTokenizerDriver {
	public static void main(String args[]) throws IOException {
		 ...
		 * "Usage java searchengine.parser.HttpTokenizerDriver <URL>"); } else{
		 * return; }
		 */
		StreamTokenizer st = null;
		try {
			st = new StreamTokenizer(new URLTextReader(new URL(
					"http://www.google.com")));
		...
		while ((i = ht.nextToken()) != HttpTokenizer.HT_EOF) {
			/*
			 * if(i==HttpTokenizer.HT_WORD){ System.out.println("Word: "+st);
